...
#      editprofile GET    /editprofile(.:format)           users#edit
#            login GET    /login(.:format)                 session#new
#                  POST   /login(.:format)                 session#create
#                  DELETE /login(.:format)                 session#destroy
#     argument_for POST   /arguments/:id/for(.:format)     arguments#for
# argument_against POST   /arguments/:id/against(.:format) arguments#against
#
